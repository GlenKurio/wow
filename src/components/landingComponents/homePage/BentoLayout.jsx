function BentoLayout() {
  return (
    <section className="md:grid md:grid-cols-12 md:grid-rows-12 flex flex-col gap-4 mt-32">
      <article className=" bg-gradient-to-r from-[#8d2de23b] to-[#4b00e042] backdrop-blur-[50px] md:col-span-8 md:row-span-8 h-[520px]  rounded-lg p-6 shadow-lg flex flex-col justify-between gap-4 ">
      ...
      <article className=" bg-gradient-to-r from-[#8d2de23b] to-[#4b00e042] backdrop-blur-[50px] md:col-span-4 md:row-span-4 rounded-lg p-4 shadow-lg flex justify-between items-center gap-4">
      ...
      <article className="bg-gradient-to-r from-[#8d2de23b] to-[#4b00e042] backdrop-blur-[50px] md:col-span-4 md:row-span-4 rounded-lg p-6 shadow-lg flex justify-between items-center gap-4">
        <div className="flex items-center h-full rounded-md w-[60%]">
          <img
      ...
      <article className="bg-gradient-to-r from-[#8d2de2] to-[#4b00e0] backdrop-blur-[50px] md:row-span-4 md:col-span-5 rounded-lg p-6 shadow-lg flex flex-col gap-8 justify-center">
      ...
      <article className=" bg-gradient-to-r from-[#8d2de23b] to-[#4b00e042] backdrop-blur-[50px] md:row-span-4 md:col-span-7 rounded-lg p-6 shadow-lg flex flex-col gap-4">
